...
>(({ className, onClick, children, asChild = false, variant, size, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(asChild ? null : "h-7 w-7", className)}
      ...
      {...props}
    >
      {children || ( // Render children if provided (asChild case), otherwise default icon
        <>
          <PanelLeft />
...
const SidebarMenuButton = React.memo(SidebarMenuButtonInner);
